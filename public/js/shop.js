...
(function ($) {
  ...
  function categorySubMenuToggle() {
    ...
    if (screenSize <= 991) {
      ...
      $('.category-menu .right-menu ul').slideUp(); //        $('.category-menu .menu-item-has-children i').on('click', function(e){
      //            e.preventDefault();
  ...
  $('.category-menu-list').on('click', 'li a, li a .menu-expand', function (e) {
    ...
    if ($a.parent().hasClass('right-menu')) {
      if ($a.attr('href') === '#' || $(this).hasClass('menu-expand')) {
        if ($a.siblings('ul:visible').length > 0) $a.siblings('ul').slideUp();else {
