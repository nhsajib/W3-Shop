            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="header-top-left">
                        <ul class="phone-wrap">
                            <li><span>Helpline :</span><a href="#">(+123) 123 321 345</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="header-top-right">
                        <ul class="ht-menu">
                            <!-- Begin Setting Area -->
                            <li>
                                <div><a href="" class="ht-right-link"><i class="fa fa-user-circle-o" aria-hidden="true"></i> My Account</a></div>
                            </li>
                            <li>
                                <div><a href="" class="ht-right-link"><i class="fa fa-check-square" aria-hidden="true"></i> Checkout</a></div>
                            </li>
                            <li>
                                <div><a href="" class="ht-right-link"><i class="fa fa-lock" aria-hidden="true"></i> Login/Register</a></div>
                            </li>
